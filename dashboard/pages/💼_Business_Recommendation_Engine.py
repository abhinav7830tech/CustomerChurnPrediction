...
def _inject_css() -> None:
    ...
    * { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
    ...
    /* ── Metric tiles (match Analytics KPI cards) ── */
    .kpi-card {
        position: relative;
        background: #234556;
        border: 1px solid rgba(255,255,255,0.08);
    ...
    .kpi-risk { color: #D97C7C; }
    .kpi-safe { color: #8FA28A; }

    /* ── Executive summary grid (01) ── */
    .es-grid {
        display: grid;
    ...
    .rule-head { display: flex; align-items: flex-start; gap: 0.85rem; margin-bottom: 0.7rem; }
    .rule-icon {
        font-size: 1.35rem;
        flex-shrink: 0;
        background: #234556;
    ...
    .rule-title { font-size: 0.92rem; font-weight: 700; color: #F4F2EE; line-height: 1.35; }
    .rule-condition {
        font-size: 0.78rem;
        color: #9BCEC1;
        line-height: 1.5;
    ...
    .rule-meta { display: flex; flex-direction: column; gap: 0.45rem; }
    .rule-meta-item {
        display: flex;
    ...
    .rule-meta-label { color: #D6D8D8; opacity: 0.7; }
    .rule-meta-value { color: #F4F2EE; font-weight: 600; text-align: right; }
    ...
    .rec-reason { font-size: 0.78rem; color: #D6D8D8; opacity: 0.85; line-height: 1.5; margin-bottom: 0.8rem; }
    .rec-meta { display: flex; flex-direction: column; gap: 0.4rem; }
    .rec-meta-item {
        display: flex;
        justify-content: space-between;
        gap: 0.75rem;
    ...
    .cb-value { font-size: 1.7rem; font-weight: 800; color: #F4F2EE; }
    .roi-row {
        display: flex;
        align-items: center;
        justify-content: space-between;
    ...
    .roi-label { font-size: 0.72rem; font-weight: 600; color: #D6D8D8; text-transform: uppercase; letter-spacing: 0.08em; }
    .roi-value { font-size: 1.9rem; font-weight: 800; color: #C8A96B; }
    ...
    .seg-card.current { transform: translateY(-3px); }
    .seg-icon { font-size: 1.7rem; }
    .seg-name { font-size: 1rem; font-weight: 800; color: #F4F2EE; margin: 0.4rem 0 0.3rem; }
    .seg-tag {
    ...
    .seg-desc { font-size: 0.74rem; color: #D6D8D8; opacity: 0.85; line-height: 1.5; }
    ...
    .camp-value { font-size: 0.9rem; color: #F4F2EE; font-weight: 600; line-height: 1.5; }
    ...
    .tl-phase { font-size: 0.9rem; font-weight: 700; color: #F4F2EE; }
    .tl-time {
        font-size: 0.7rem;
        color: #C8A96B;
        font-weight: 700;
    ...
    .tl-action { font-size: 0.8rem; color: #D6D8D8; opacity: 0.85; line-height: 1.5; }

    /* ── Manager notes (10) ── */
    .notes-box { font-size: 0.95rem; color: #F4F2EE; line-height: 1.85; }
    ...
    .entry-icon { font-size: 2.4rem; margin-bottom: 0.85rem; }
    .entry-title { font-size: 1.2rem; font-weight: 700; color: #F4F2EE; margin-bottom: 0.55rem; }
    .entry-text {
        font-size: 0.84rem;
        color: #D6D8D8;
        line-height: 1.6;
    ...
    .waiting-title { font-size: 1.2rem; font-weight: 700; color: #F4F2EE; margin-bottom: 0.55rem; }
    .waiting-text {
        font-size: 0.82rem;
        color: #D6D8D8;
        opacity: 0.75;
    ...
    .validation-title { font-size: 0.86rem; font-weight: 700; color: #D97C7C; margin-bottom: 0.5rem; }
    .validation-item {
        font-size: 0.8rem;
        color: #F4F2EE;
        padding: 0.25rem 0;
...
def _header() -> None:
    ...
    st.markdown(
        ...
        '<div class="page-kicker">◆ Business Recommendation Engine</div>'
        '<div class="page-title">Turn Every Prediction Into a Retention Plan</div>'
