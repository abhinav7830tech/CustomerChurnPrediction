...
def _inject_css() -> None:
    ...
    * { font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }
    ...
    .prob-value { font-size: 2.3rem; font-weight: 800; color: #F4F2EE; letter-spacing: -0.01em; }
    ...
    .risk-row { display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1.2rem; }
    .risk-pill {
        display: inline-flex;
        align-items: center;
        gap: 0.55rem;
    ...
    /* ── Model info mini-grid ── */
    .mi-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 0.8rem 1rem; }
    .mi-item {
        background: #163949;
        border: 1px solid rgba(255,255,255,0.06);
        border-radius: 12px;
    ...
    .mi-value { font-size: 0.98rem; font-weight: 700; color: #F4F2EE; }
    ...
    .factor-value { font-size: 0.74rem; color: #D6D8D8; opacity: 0.8; margin-top: 0.1rem; }
    .factor-impact {
        font-size: 0.74rem;
        font-weight: 700;
        white-space: nowrap;
    ...
    .why-box p { margin: 0 0 0.8rem 0; }
    .why-box b { color: #C8A96B; font-weight: 700; }
    ...
    .whatif-value { font-size: 1.15rem; font-weight: 700; color: #F4F2EE; margin-bottom: 1rem; }
    .whatif-current { font-size: 0.78rem; color: #D6D8D8; opacity: 0.8; margin-bottom: 1.1rem; }
    .delta-row {
        display: flex;
        align-items: center;
        flex-wrap: wrap;
    ...
    .delta-arrow { font-size: 1.4rem; color: #D6D8D8; }
    .delta-badge {
        font-size: 0.85rem;
        font-weight: 800;
        color: #0F3040;
    ...
    .delta-verdict { font-size: 0.85rem; font-weight: 700; margin-left: 0.25rem; }
    .whatif-note {
        font-size: 0.75rem;
        color: #D6D8D8;
        opacity: 0.75;
    ...
    .rec-text { font-size: 0.78rem; color: #D6D8D8; opacity: 0.85; line-height: 1.5; margin-bottom: 0.8rem; }
...
def _header() -> None:
    ...
    st.markdown(
        ...
        '<div class="page-kicker">◆ Explainable AI</div>'
        '<div class="page-title">Why Did the Model Decide That?</div>'
